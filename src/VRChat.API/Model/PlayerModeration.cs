...
namespace VRChat.API.Model
{
    ...
    public partial class PlayerModeration : IEquatable<PlayerModeration>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "sourceDisplayName", IsRequired = false, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "sourceUserId", IsRequired = false, EmitDefaultValue = true)]
        public string SourceUserId { get; set; }

        /// <summary>
        /// Gets or Sets TargetDisplayName
        /// </summary>
        [DataMember(Name = "targetDisplayName", IsRequired = false, EmitDefaultValue = true)]
